...
$res = mysqli_query($con,"select * from plantation where location = '$location' and edate >= '$today' ;") ;
if(!$res)
{
...
if(isset($_POST['submit']))
{
  ...
  $new = mysqli_query($con, "insert into plantation(ename,edate,eaddr,estime,eetime,ereq,location) values('$ename','$edate','$eaddr','$estime','$eetime','$ereq','$location')");
...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav">   
    <ul>
      ...
      <li class="active"><a href="plantation.php"><i class="fa fa-calendar"></i>Plantation Programmes</a></li>
