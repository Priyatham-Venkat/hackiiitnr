...
$res = mysqli_query($con,"select * from awareness where location = '$location' and edate >= '$today' ;") ;
if(!$res)
{
...
{
  $eid = $_POST['evid'] ;
  $join = mysqli_query($con,"insert into volunteer values('$eid','$name','awareness');");
  if(!$join)
    {
      echo "<script>";
...
if(isset($_POST['submit']))
{
  ...
  $new = mysqli_query($con, "insert into awareness(ename,edate,eaddr,estime,eetime,ereq,location) values('$ename','$edate','$eaddr','$estime','$eetime','$ereq','$location')");
...
<section id="sidebar"> 
  ...
  <div id="sidebar-nav">   
    <ul>
      ...
      <li class="active"><a href="awareness.php"><i class="fa fa-calendar"></i>Awareness Campaign</a></li>
